...
export class KestrelLayoutC extends Ship {
  constructor() {
    ...
    this.rooms = [
      new Room(new RoomDisplaySettings(198, 211, 2, 2), new Shield(2)),
      new Room(new RoomDisplaySettings(59, 176, 2, 2), new Engine(2), this.crews[1]),
      new Room(new RoomDisplaySettings(302, 176, 1, 2), new Oxygen()),
      new Room(new RoomDisplaySettings(198, 141, 2, 2), new WeaponControl(2), this.crews[2]),
      ...
      new Room(new RoomDisplaySettings(94, 140, 2, 1), new Cloacking(1, false)),
      new Room(new RoomDisplaySettings(129, 176, 2, 2), new DroneControl(1, false)),
      new Room(new RoomDisplaySettings(94, 245, 2, 1), new Hacking(1, false)), // Manage advancedEditionEnabled
      ...
      new Room(new RoomDisplaySettings(338, 246, 2, 1), new MindControl(1, false)),
      new Room(new RoomDisplaySettings(371, 176, 1, 2), new Battery(1, false)),
    ];
