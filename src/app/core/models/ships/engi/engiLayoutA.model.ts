...
import { DoorControl, DroneControl, Engine, Medbay, Oxygen, Piloting, Sensor, Shield, WeaponControl } from '../../systems/index';
...
export class EngiLayoutA extends Ship {
  constructor() {
    ...
    this.rooms = [
      ...
      // new Room(new Engine(2), this.crews[0]), // Engi
      // new Room(new Oxygen()),
      // new Room(new WeaponControl(3), this.crews[1]), // Engi
      // new Room(new DroneControl(3)),
      // new Room(new Medbay()),
      // new Room(new Piloting(), this.crews[2]), // Human Male
      // new Room(new Sensor()),
